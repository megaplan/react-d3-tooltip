    ...
    value: function render() {
      ...
      if (contentTooltip) {
        if (this.props.children) {
          contentTooltipTmpl = _react2['default'].cloneElement(this.props.children, {
            contentTooltip: contentTooltip,
            position: position
          });
        } else {
          contentTooltipTmpl = _react2['default'].createElement(_tooltipTable2['default'], { contentTooltip: contentTooltip, position: position });
        }
      }
