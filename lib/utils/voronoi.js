...
var Voronoi = function (_Component) {
  ...
  function Voronoi(props) {
    ...
    return _possibleConstructorReturn(this, (Voronoi.__proto__ || Object.getPrototypeOf(Voronoi)).call(this, props));
  }
  ...
  _createClass(Voronoi, [{
    ...
    value: function _setGeomVoronoi() {
      var _props3 = this.props,
          ...
          x = _props3.x,
          xScaleSet = _props3.xScaleSet,
          y = _props3.y,
          yScaleSet = _props3.yScaleSet,
          stack = _props3.stack;
      ...
      }).clipExtent([[0, 0], [width - margins.right - margins.left, height - margins.bottom - margins.top]]);
